            ...
            <div>
                <nav className="nav-wrapper grey darken-4 navbar">
                    <div className="container">
                        <b><a href="/" className="brand-logo">EviSecure</a></b>
                        <ul className = "right">
                ...
                <h4 className="title-styled" style={{marginTop: "40px", marginLeft: "235px", marginBottom:"10px",color:"white"}}>Pending Forensic Reports</h4>
                <div className = "container homeList center">
                <div className="card lightseagreen darken-3 headers"style={{backgroundColor:"lightseagreen"}}>
                    <div className="row ">
